...
{
    register_taxonomy_for_object_type('category', 'team_members'); // Register Taxonomies for Category
    register_taxonomy_for_object_type('post_tag', 'team_members');
    register_post_type('team_members', // Register Custom Post Type
        array(
        'labels' => array(
            'name' => __('Team Members', 'team_members'), // Rename these to suit
            'singular_name' => __('Team Member', 'team_member'),
            'add_new' => __('Add New', 'team_member'),
            'add_new_item' => __('Add New Team Member', 'team_member'),
            'edit' => __('Edit', 'team_member'),
            'edit_item' => __('Edit Team Member', 'team_member'),
            'new_item' => __('New Team Member', 'team_member'),
            'view' => __('View Team Member', 'team_member'),
            'view_item' => __('View Team Member', 'team_member'),
            'search_items' => __('Search Team Members', 'team_members'),
            'not_found' => __('No Team Member found', 'team_member'),
...
function deliver_contact_mail() {
    ...
    if ( isset( $_POST['rt-submitted'] ) ) {
        ...
        if ( wp_mail( $to, $subject, $message, $headers  ) ) {
            // make this work at a later date
        } else {
...
function rt_cf_shortcode() {
    ob_start();
    deliver_contact_mail();
    contact_form_markup();
...
acf_add_local_field_group(array (
    'key' => 'group_597fa5507e293',
    'title' => 'Footer',
    'fields' => array (
        array (
            'key' => 'field_597fa57b50357',
            'label' => 'Copy',
            'name' => 'copy',
            'type' => 'textarea',
            'instructions' => '',
...
acf_add_local_field_group(array (
    'key' => 'group_597be9b80feba',
    'title' => 'Post Module',
    'fields' => array (
        array (
            'key' => 'field_597be9be95ff4',
            'label' => 'Subtitle',
            'name' => 'subtitle',
            'type' => 'text',
            'instructions' => '',
...
acf_add_local_field_group(array (
    'key' => 'group_597b943d34321',
    'title' => 'Projects Page Builder',
    'fields' => array (
        array (
            'key' => 'field_597b94f7ba283',
            'label' => 'Content Block',
            'name' => 'content_block',
...
acf_add_local_field_group(array (
    'key' => 'group_597bb8388303b',
    'title' => 'Team Page Builder',
    'fields' => array (
        array (
            'key' => 'field_597bb83886658',
            'label' => 'Content Block',
            'name' => 'content_block',
            'type' => 'flexible_content',
            'instructions' => '',
